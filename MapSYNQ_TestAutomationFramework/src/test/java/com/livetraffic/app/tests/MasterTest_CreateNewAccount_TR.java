...
@CucumberOptions(features = {"classpath:feature_files_list/mapSYNQVerifyTrafficParking.feature"}, glue = {"com.livetraffic.app.stepdefinition"}, 
			plugin = { "pretty", "json:target/cucumber",
			"com.cucumber.listener.ExtentCucumberFormatter" })
public class MasterTest_CreateNewAccount_TR {
	@BeforeClass
